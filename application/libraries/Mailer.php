...

{
    ...
    protected $email_pengirim = 'sinarmudakreatif@ikionline.id'; // Isikan dengan email pengirim

    protected $nama_pengirim = 'Sinar Muda Kreatif'; // Isikan dengan nama pengirim

    protected $password = '1000Ribu'; // Isikan dengan password email pengirim
...

    {
        ...
        // $mail->AddEmbeddedImage('assets/img/email/logo_bawah.png', 'logo'); // Aktifkan jika ingin menampilkan gambar dalam email

        // $mail->AddEmbeddedImage('assets/img/email/bg_1.jpg', 'bg-iki-warung');

        // $mail->AddEmbeddedImage('assets/img/email/unduh.png', 'unduh');
