                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Driver Taksi</h6>
                        </div>
                        <div class="card-body">

                            <a class="btn btn-primary" href="<?= site_url('C_Taksi/form_tambah') ?>">Tambah</a>
                            <br><br>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        if (!empty($data_taksi)) {
                                            foreach ($data_taksi as $key => $value) {
                                        ?>
                                                <tr>
                                                    <td><?= $value['email'] ?></td>
                                                    <td><?= $value['nama'] ?></td>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a class="btn btn-warning" href="<?= site_url('C_Taksi/form_edit/' . $key) ?>">Edit</a>
                                    <a class="btn btn-danger" href="<?= site_url('C_Taksi/delete_data/' . $key) ?>">Hapus</a>
                                </div>
                            </div>
                        </div>
                    </div>
