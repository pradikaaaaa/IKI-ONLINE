...
class Send_email extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config = [
            ...
            'smtp_user' => 'sinarmudakreatif.pt@gmail.com',  // Email gmail
            'smtp_pass'   => 'wfqiuujslbblzgmo',  // Password gmail
            'smtp_crypto' => 'ssl',
            'smtp_port'   => 465,
            'crlf'    => "\r\n",
            'newline' => "\r\n"
        ...
        // Email penerima
        $this->email->to('yahyapradika87@gmail.com'); // Ganti dengan email tujuan
